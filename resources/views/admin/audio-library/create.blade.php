            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Multi Columns Form -->
                        <form class="row g-3 m-auto" action="{{ route('audio-library.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-sm-12">
                                ...
                                <input name="date_of_recording" id="date_of_recording" type="date" class="form-control" value="{{ old('date_of_recording') }}" />
